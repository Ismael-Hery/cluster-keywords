...
function printClusterKeywords(articles) {
  ...
  articles.forEach(function(article) {
    addArticleKwsToClusterKws(article);
  });
 ...
 * @param {Object}   article Article as returned from cluster api, with fields id and title and conten
 */
function addArticleKwsToClusterKws(article) {
